                                                    ...
                                                    <div class="col-lg-12">
                                                        <form action="/kategori/{{$kategori->id_kategori}}/update" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name='kategori' type="text" class="form-control" aria-describedby="Kategori" placeholder="Kategori" value="{{$kategori->kategori}}">
                                                            </div>
                                                            <div class="modal-footer">
                                                                <a href="/kategori"></ahref><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
