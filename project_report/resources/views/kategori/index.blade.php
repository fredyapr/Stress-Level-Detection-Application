                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="datatable">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="/kategori/{{$kategori->id_kategori}}/edit" class="btn fa fa-edit btn-success btn-sm"></a> &nbsp;&nbsp;<a href="/kategori/{{$kategori->id_kategori}}/delete" class="btn fa fa-trash-o btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus?')"></a></td>
                                                                </tr>
                                                            </tbody>
            ...
            <div class="modal-body">
                <form action="{{url('/kategori/create')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name='kategori' type="text" class="form-control" aria-describedby="Kategori" placeholder="Kategori">
                    </div>
