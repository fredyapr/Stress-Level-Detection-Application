                                        ...
                                        <div class="col-sm-12">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                    <?php
                                                        $update = url('/solusi/'.$solusi->id_solusi.'/update/');
                                                    ?>
                                                        <form action="{{$update}}" method="POST">
                                                            {{csrf_field()}}
                                                            <div class="form-group">
                                                                <label for="exampleInputSolusi">Solusi</label>
                                                                <input name='solusi' type="text" class="form-control" aria-describedby="Solusi" placeholder="Solusi" value="{{$solusi->solusi}}" required="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputSolusi">Keterangan</label>
                                                                <textarea name='keterangan' type="text" class="form-control" aria-describedby="Keterangan" placeholder="Keterangan" rows="5" value="{{$solusi->keterangan}}" required=""></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <a href="{{url('/solusi')}}"></ahref><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
